...
<link href="${base}/dist/vendors/jquery-tree/css/jquery.treetable.css" rel="stylesheet" type="text/css"/>
<link href="${base}/dist/vendors/jquery-tree/css/jquery.treetable.theme.default.css" rel="stylesheet" type="text/css"/>
<script src="${base}/dist/vendors/jquery-tree/jquery.treetable.js"></script>
