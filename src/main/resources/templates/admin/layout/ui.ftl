...
<head>
    ...
    <!-- jQuery -->
    <script src="${base}/dist/vendors/jquery/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="${base}/dist/vendors/bootstrap/js/bootstrap.min.js"></script>
    <script src='${base}/dist/vendors/jquery/jquery-validate.js'></script>
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="${base}/index" class="logo">
            <span class="logo-mini">w's site</span>
            <span class="logo-lg"><b>Wangxueming's</b> Site</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="#">Wangxueming's Site</a>.</strong> All rights reserved.
    </footer>
</body>
</html>
</#macro>
