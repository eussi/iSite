    ...
    <div class="box-body">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="site_domain" class="form-control" value="${values['site_domain'].value}" placeholder="示例: http://eussi.com">
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" name="site_icp" class="form-control" value="${values['site_icp'].value}" placeholder="示例: 豫ICP备12345678号">
                </div>
            </div>
            <div class="form-group">
