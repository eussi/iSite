...
<form id="submitForm" class="form" action="${base}/post/submit" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="isMarkdown" value="${view.isMarkdown!1}"/>
    <div class="row">
    ...
    <div class="col-xs-12 col-md-12">
        <div class="form-group">
            <div class="text-center">
                <button type="button" id="switch-editor" class="btn btn-primary" style="padding-left: 30px; padding-right: 30px;">切换普通编辑器</button>
            </div>
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    $("#switch-editor").click(function() {
        window.location.href = "${base}/post/editing?editor=ue";
    });
</script>
</@layout>
