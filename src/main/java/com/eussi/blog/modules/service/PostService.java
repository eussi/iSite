...
public interface PostService {
	 ...
	 * @param ord   排序
	 */
	Page<PostVO> paging(Page page, int channelId, Set<Integer> excludeChannelIds, String ord);

	Page<PostVO> paging4Admin(Page page, long id, String title, int channelId);
	 ...
	 * @param userId
	 */
	Page<PostVO> pagingByAuthorId(Page page, long userId);
